...
- [ ] Build tenant support diagnostics toolkit (auth/domain/ingestion health checks with operator-friendly remediation actions). (Now top priority after data safety/recovery controls completion on 2026-02-20.)
